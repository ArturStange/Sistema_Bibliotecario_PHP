...
Um sistema web completo para a gestão de uma biblioteca académica, desenvolvido como requisito para a avaliação do **Trabalho A3 de PHP**. O sistema permite o controlo do acervo literário, gestão de empréstimos, sistema de avaliações e diferentes níveis de privilégios de acesso.
